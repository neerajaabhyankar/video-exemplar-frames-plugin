...
5. Tested Annotation Propagation on some of the frames using quicktests/annoprop_frames.py (hacky script, to be deleted)
...
8. First, testing Annotation Propagation only. See tests/test_annoprop.py
